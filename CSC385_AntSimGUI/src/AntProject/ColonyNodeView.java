...
public class ColonyNodeView extends JPanel
{
    ...
    private void initComponents()
    {
        ...
        URL queen = ColonyNodeView.class.getClassLoader().getResource("queen.gif");
        queenIcon = new JLabel(new ImageIcon(queen));
        queenIcon.setVisible(false);

        // indicates presence of scout ant
        URL scout = ColonyNodeView.class.getClassLoader().getResource("scout.gif");
        scoutIcon = new JLabel(new ImageIcon(scout));
        scoutIcon.setVisible(false);

        // indicates presence of forager ant
        URL forager = ColonyNodeView.class.getClassLoader().getResource("forager.gif");
        foragerIcon = new JLabel(new ImageIcon(forager));
        foragerIcon.setVisible(false);

        // indicates presence of soldier ant
        URL soldier = ColonyNodeView.class.getClassLoader().getResource("soldier.gif");
        soldierIcon = new JLabel(new ImageIcon(soldier));
        soldierIcon.setVisible(false);

        // indicates presence of Bala ant
        URL bala = ColonyNodeView.class.getClassLoader().getResource("bala.gif");
        balaIcon = new JLabel(new ImageIcon(bala));
